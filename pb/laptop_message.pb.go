...
type Laptop struct {
	...
	//
	// Types that are assignable to Weigh:
	//	*Laptop_WeighKg
	//	*Laptop_WeighLb
	Weigh       isLaptop_Weigh       `protobuf_oneof:"weigh"`
...
func (m *Laptop) GetWeigh() isLaptop_Weigh {
	if m != nil {
		return m.Weigh
	}
	return nil
...
func (x *Laptop) GetWeighKg() float64 {
	if x, ok := x.GetWeigh().(*Laptop_WeighKg); ok {
		return x.WeighKg
	}
	return 0
}

func (x *Laptop) GetWeighLb() float64 {
	if x, ok := x.GetWeigh().(*Laptop_WeighLb); ok {
		return x.WeighLb
	}
	return 0
}
...
type isLaptop_Weigh interface {
	isLaptop_Weigh()
}

type Laptop_WeighKg struct {
	WeighKg float64 `protobuf:"fixed64,10,opt,name=weigh_kg,json=weighKg,proto3,oneof"`
}

type Laptop_WeighLb struct {
	WeighLb float64 `protobuf:"fixed64,11,opt,name=weigh_lb,json=weighLb,proto3,oneof"`
}

func (*Laptop_WeighKg) isLaptop_Weigh() {}

func (*Laptop_WeighLb) isLaptop_Weigh() {}
...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xe5, 0x03, 0x0a, 0x06, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x12, 0x0e,
	...
	0x50, 0x55, 0x52, 0x03, 0x63, 0x70, 0x75, 0x12, 0x20, 0x0a, 0x03, 0x52, 0x61, 0x6d, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65,
	0x6d, 0x6f, 0x72, 0x79, 0x52, 0x03, 0x52, 0x61, 0x6d, 0x12, 0x1f, 0x0a, 0x04, 0x67, 0x70, 0x75,
	...
	0x61, 0x72, 0x64, 0x52, 0x08, 0x6b, 0x65, 0x79, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x12, 0x1b, 0x0a,
	0x08, 0x77, 0x65, 0x69, 0x67, 0x68, 0x5f, 0x6b, 0x67, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x01, 0x48,
	0x00, 0x52, 0x07, 0x77, 0x65, 0x69, 0x67, 0x68, 0x4b, 0x67, 0x12, 0x1b, 0x0a, 0x08, 0x77, 0x65,
	0x69, 0x67, 0x68, 0x5f, 0x6c, 0x62, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x01, 0x48, 0x00, 0x52, 0x07,
	0x77, 0x65, 0x69, 0x67, 0x68, 0x4c, 0x62, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x72, 0x69, 0x63, 0x65,
	...
	0x41, 0x74, 0x42, 0x07, 0x0a, 0x05, 0x77, 0x65, 0x69, 0x67, 0x68, 0x42, 0x0b, 0x5a, 0x09, 0x70,
